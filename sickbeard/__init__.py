...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                DTT, DTT_NORAR, DTT_SINGLE, THEPIRATEBAY, THEPIRATEBAY_TRUSTED, THEPIRATEBAY_PROXY, THEPIRATEBAY_PROXY_URL, THEPIRATEBAY_BLACKLIST, TORRENTLEECH, TORRENTLEECH_USERNAME, TORRENTLEECH_PASSWORD, NYAA, FROZENLAYER, \
        ...
        # this is the normal codepath for metadata config
            ...
            METADATA_MINIDLNA = check_setting_str(CFG, 'General', 'metadata_minidlna', '0|0|0|0|0|0')
            ...
            for cur_metadata_tuple in [(METADATA_XBMC, metadata.xbmc),
                                       ...
                                       (METADATA_MINIDLNA, metadata.minidlna),
                                       ]:
...
def save_config():
    ...
    new_config['General']['metadata_minidlna'] = metadata_provider_dict['minidlna'].get_config()
